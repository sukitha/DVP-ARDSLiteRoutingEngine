...
RUN go get gopkg.in/DuoSoftware/DVP-ARDSLiteRoutingEngine.v2/ArdsLiteRoutingEngine

# Build the outyet command inside the container.
# (You may fetch or manage dependencies here,
# either manually or with a tool like "godep".)
#RUN go install github.com/DuoSoftware/DVP-ARDSLiteRoutingEngine/ArdsLiteRoutingEngine
RUN go install gopkg.in/DuoSoftware/DVP-ARDSLiteRoutingEngine.v2/ArdsLiteRoutingEngine
